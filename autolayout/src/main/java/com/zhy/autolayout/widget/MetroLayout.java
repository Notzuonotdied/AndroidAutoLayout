...
public class MetroLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0, n = getChildCount(); i < n; i++) {
            ...
            MetroBlock newPos = findAvailablePos();
            left = newPos.left;
            top = newPos.top;
    ...
    private MetroBlock findAvailablePos() {
        MetroBlock p = new MetroBlock();
        ...
        for (MetroBlock metroBlock : mAvailablePos) {
            if (metroBlock.top < min) {
                min = metroBlock.top;
                minHeightPos = metroBlock;
            }
        }
        return minHeightPos;
    }
